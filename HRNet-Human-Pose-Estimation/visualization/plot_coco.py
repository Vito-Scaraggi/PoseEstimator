...
# Xiaochu Style
# (R,G,B)
color1 = [(255,0,0) for _ in range(8)]

#, (254,153,41),(255,255,51),    (44,127,184),(0,0,255)]

link_pairs1 = [[0, 1], [1, 2], [3, 4], [4, 5], [6, 7], [7, 8], [9, 10], [10, 11]]

point_color1 = [(0,0,255) for _ in range(12)]
'''
,(255,255,51),(228,26,28),
...
# Chunhua Style
# (R,G,B)
color2 = [(255,0,0) for _ in range(8)]
#, (255,255,0),(169, 209, 142),(169, 209, 142),(169, 209, 142)]

link_pairs2 = [[0, 1], [1, 2], [3, 4], [4, 5], [6, 7], [7, 8], [9, 10], [10, 11]]

point_color2 = [(0,0,255) for _ in range(12)]
'''
...
def parse_args():
    ...
    parser.add_argument('--image-path',
                        ...
                        type=str,
                        default='data/babypose/images/dummy_test/'
                        )

    parser.add_argument('--gt-anno',
                        help='Path of COCO val annotation',
                        type=str,
                        default='data/babypose/annotations/person_keypoints_dummy_test.json'
                        )
        ...
        for imgId in p.imgIds[:5000]:
            ...
            for j, gt in enumerate(gts):
                ...
                for i, dt in enumerate(dts):
                    ...
                    if iou < 0.1 or score < threshold:
                        ...
                        num_box += 1
                        sum_score += dt['score']
                        dt_joints = np.array(dt['keypoints']).reshape(12,-1)
            ...
            if save:
                plt.savefig(save_path + \
                           ...
                           '_'+img_name + '.png', 
                           format='png', dpi=100)
                plt.savefig(save_path +'id_'+str(imgId)+ '.pdf', format='pdf', dpi=100)
            # plt.show()
            plt.close()
